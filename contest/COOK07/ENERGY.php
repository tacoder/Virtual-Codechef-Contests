<?php require("../../includes/header.php"); ?><h1>Dance Floor Energy</h1><div class="content">
...
<p>
Say B is the total number of boys on the guest list and G is the total number of girls on the guest list. Your goal is the following. For each integer m between 0 and min(B,G), you should determine the total time that the maximum number of couples that the Chef can assign to the dance floor is m.</p>
<h3>Input</h3>

<p>
The first line contains a single positive integer T ≤ 30 describing the number of test cases. Each test case begins with three positive integers B, G, and L. B is the number of boys that will attend the dance and G is the number of girls. L indicates the length of the dance.</p>
<p>
...
<p>
Then G lines follow, each describe a girl in the same manner. The only difference is that 0 ≤ N ≤ B and the last N integers on a line corresponding to a girl are distinct integers between 0 and B-1 describing the boys that the girl is interested in dancing with.</p>
<p>
Bounds: Both B and G are integers between 1 and 200 and L is an integer between 1 and 1,000,000,000.</p>
<h3>Output</h3>
...
<p>
Recall that a pair between a particular boy and a particular girl can only be formed at a given moment of time if both are present at that time and each is interested in dancing with the other.</p>
<h3>Example</h3>
<pre>
<b>Input:</b>
4
...
</pre><h3>Test Case Annotation</h3>

<p>
For the first test case, we have:</p>
<p>
...
<p>
So, the total time with m = 0 is 7, the total time with m = 1 is 2, and the total time with m = 2 is 1.</p>
