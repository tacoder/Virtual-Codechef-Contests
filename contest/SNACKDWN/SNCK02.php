<?php require("../../includes/header.php"); ?><h1>Powerful Strongholds</h1><div class="content">
...
<p><b>1</b>.For every stronghold y which does not belong to S, there is a road leading to it from a stronghold x which belongs to S.  This way, any stronghold not in S is ‘threatened’ by a stronghold in S.
</p>
<p><b>2</b>.S can properly defend (defined next) any attack from strongholds outside of S.</p>
<p><b>The mechanism for attacking and defending S is defined as follows:</b>
</p>
<p><b>i</b>.In an attack, each single stronghold y not belonging to S will select one of its neighbor z belonging to S (if any) to attack.  In this case y is an attacker of z.
</p>
<p><b>ii</b>.Given the attack routes of all y not belonging to S, each stronghold x belonging to S may decide to defend one of its neighbors, say z,  in which case x is a defender of z.  Alternatively, x may decide to defend itself, in which case x is a defender of x.
</p>
