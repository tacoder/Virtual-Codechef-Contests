<?php require("../../includes/header.php"); ?><h1>Chef and Functions</h1><div class="content">
<h3> Read problems statements in <a target="_blank" href="http://www.codechef.com/download/translated/JUNE14/mandarin/FUNC.pdf">Mandarin Chinese </a> and <a target="_blank" href="http://www.codechef.com/download/translated/JUNE14/russian/FUNC.pdf">Russian</a>.</h3>
...
<p> Now the chef defines another function <b> val(x, A, N) </b> as follows : <br /> <br /></p>
<p><b> val(x, A, N) =  root(1, x)*A[1]  +  root(2, x)*A[2] +  ...  + root(N, x)*A[N] </b> <br /> <br /></p>
