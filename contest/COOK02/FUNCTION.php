<?php require("../../includes/header.php"); ?><h1>Backup Functions</h1><div class="content">

<p>
One unavoidable problem with running a restaurant is that occasionally a menu item cannot be prepared. This can be caused by a variety of reasons such as missing ingredients or malfunctioning equipment.</p>
<p>
...
<p>
The first line contains a single integer T ≤ 30 indicating the number of test cases.</p>
<p>
Each test case begins with two integers N and M where 3 ≤ N ≤ 10,000 and 3 ≤ M ≤ 50,000 where N is the number of items in the menu. The menu items will be numbered 1 through N.</p>
<p>
M lines follow, each containing three integers a,b, and v. Here 1 ≤ a &lt; b ≤ N and |v| ≤ 100,000. Such a triple indicates that f(a) = b or f(b) = a (but not both) may be used in a backup function. Setting either f(a) = b or f(b) = a has effectiveness v. Each pair 1 ≤ a &lt; b ≤ N will occur at most once in the input.</p>
<p>
Test cases will be separated by a single blank line (including a blank line preceding the first test case).</p>
<h3>Output</h3>
