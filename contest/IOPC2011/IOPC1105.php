<?php require("../../includes/header.php"); ?><h1>Military patrol</h1><div class="content">
...
<p>Now note that:</p>
<ul>
<li> Every city has to appear in exactly one vehicle's patrol sequence exactly once
</li><li> Every patrol vehicle has to move - so it has to be assigned more than one city
</li></ul>
<p></p><p>The government does not have any limit on the number of patrol vehicles it can use. However, they want to make sure that the least possible amount of money is spent on the patrol mission and hence they want to minimise the total distance travelled by the patrol vehicles.</p>
...
<p>This is followed by the descriptions of the T testcases. The first line of the description contains two integers N and R, the number of cities and one way roads respectively (N&lt;=200,R&lt;=10000). The cities are numbered 1,2,3,...N<br />
This is followed by R lines, each representing a one way road by 3 integers N<sub>1</sub>, N<sub>2</sub> and D : the start city, the end city and the length of the road respectively ( N<sub>1</sub>!=N<sub>2</sub>, 1&lt;=D&lt;=1000000). You are assured that there is no more than one one way road from any N<sub>1</sub> to N<sub>2</sub></p>
<h3>Output</h3>
