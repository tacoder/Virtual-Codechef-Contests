...
<h3>Read problems statements in <a href="/download/translated/COOK47/mandarin2/PNTNG.pdf" target="_blank">Mandarin Chinese</a> and <a href="/download/translated/COOK47/russian/PNTNG.pdf" target="_blank">Russian</a> as well.</h3>
...
<h3>Explanations</h3>
<p>In the first example, we should paint 6 cells on the first layer and 6 cells on the second layer.<br /><br /> In the second example, there are not enough cells to paint the table properly.</p>    </div><table cellspacing="0" cellpadding="0" align="left">
        <tr>
