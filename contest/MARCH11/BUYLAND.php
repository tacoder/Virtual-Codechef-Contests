...
<p>If the chef decides to buy the land from (3,4) to (5,7), he will end up with the following layout:<br />
0 2 0 2<br />
0 2 0 2<br />
0 2 0 -6<br />
Comparing it to the preferred layout gives the penalty of 1+0+4+0+1+0+0+0+1+0+4+64=75, which is 4th best.</p></ul>
