...
<p>The Chef is given a list of <b>N triangles</b>. Each triangle is identfied by the coordinates of its three corners in the 2-D cartesian plane. His job is to figure out <b>how many<br />
of the given triangles are right triangles</b>. A right triangle is a triangle in which one angle is a 90 degree angle. The vertices<br />
of the triangles have integer coordinates and all the triangles given are valid( three points aren't colinear ).  </p>
<p> </p>
<h3>Input</h3>
<p>The first line of the input contains an integer <b>N</b> denoting the number of triangles. Each of the following <b>N</b><br />
lines contain six space separated integers <b>x1 y1 x2 y2 x3 y3</b> where <b>(x1, y1)</b>,<br />
<b>(x2, y2)</b> and <b>(x3, y3)</b> are the vertices of a triangle.</p>
<p> </p>
<h3>Output</h3>
