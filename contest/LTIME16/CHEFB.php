...
<h3>Read problems statements in <a href="/download/translated/LTIME16/mandarin/CHEFB.pdf" target="_blank">Mandarin Chinese </a> and <a href="/download/translated/LTIME16/russian/CHEFB.pdf" target="_blank">Russian</a>.</h3>
<p>Roma gave Chef an array of intergers.<br /> Chef wants to make all integers in the array equal to 1.<br /> In a single operation, he can select a prime number <b>p</b> and a subset of the integers, and then divide all of the integers in the subset by <b>p</b>.<br /> Chef can make this operation only if every integer in the selected subset is divisible by <b>p</b>.</p>
<p>Please help Chef to make all the integers in the array equal to 1 with minimum number of operations.</p>
<h3>Input</h3>
