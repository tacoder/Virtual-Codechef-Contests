<?php require("../../includes/header.php"); ?><h1>Chef and Segment Game</h1><div class="content">
<h3> Read problems statements in <a target="_blank" href="http://www.codechef.com/download/translated/NOV14/mandarin/CHEFSEG.pdf">Mandarin Chinese </a> and <a target="_blank" href="http://www.codechef.com/download/translated/NOV14/russian/CHEFSEG.pdf">Russian</a>.</h3>
<p> </p>
...
<h3>Explanation</h3>
<p>You can see the points coordinates for the third sample from first two samples. </p>    </div><table cellspacing="0" cellpadding="0" align="left">
        <tr>
