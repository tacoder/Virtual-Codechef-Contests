<?php require("../../includes/header.php"); ?><h1>Mountain Holidays 2</h1><div class="content">
<h3> Read problems statements in <a target="_blank" href="http://www.codechef.com/download/translated/AUG14/mandarin/MOU2H.pdf">Mandarin Chinese </a> and <a target="_blank" href="http://www.codechef.com/download/translated/AUG14/russian/MOU2H.pdf">Russian</a>.</h3>
...
<p><i>Warning</i>: The input and output can be large. Please don't use a slow input/output method.</p>    </div><table cellspacing="0" cellpadding="0" align="left">
        <tr>
