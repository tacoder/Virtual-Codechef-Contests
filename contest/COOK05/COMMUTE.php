<?php require("../../includes/header.php"); ?><h1>The Morning Commute</h1><div class="content">

<p>
The Chef commutes to work every day using the city's underground metro. The schedule for the trains has recently been changed and he wants to know how long it will take to travel from the station nearest to his house and the station nearest to his restaurant.</p>
<p>
...
<p>
Help the Chef figure out how long it will take him to travel from station s<sub>0</sub> to station s<sub>n</sub>. You may assume that the Chef is already at station s<sub>0</sub> at time 0.</p>
<h3>Input</h3>
...
<p>
The x<sub>i</sub> values will be between 0 and 1000 and the l<sub>i</sub> and f<sub>i</sub> values will be between 1 and 1000.</p>
<h3>Output</h3>

<p>
For each test case you are to output a single integer denoting the minimum time t for which the Chef can reach station s<sub>n</sub> using the given route. Remember, the Chef starts at s<sub>0</sub> at time 0.</p>
<h3>Example</h3>
<pre>
<b>Input:</b>
3
