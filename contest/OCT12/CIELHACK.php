<?php require("../../includes/header.php"); ?><h1>Ciel and password cracking</h1><div class="content">

<p>
Chef Ciel now faces a crisis situation.<br />
It is a really complicated situation, please read carefully.<br />
Here, your task is to calculate the minimum expected time for slipping out of the crisis situation.
</p>
<p>
As you know, Ciel uses a safe having <i>Box and Ball System</i> as the combination of the safe (See <b>NOTE 1</b>).<br />
...
<p>
Now Ciel has forgotten the combination for her safe and passwords for all <b>K</b> pieces!<br />
...
<p>
Since her computer is too slow,<br />
Ciel decides to use computer centers in her town. There are <b>C</b> computer centers in all.<br />
Since Ciel is afraid of leaking the combination for her safe,<br />
...
<p>
<b>The cracking program description.</b><br />
...
<p>
<b>NOTE 2.</b><br />
Consider the process of cracking the password with <b>N<sub>i</sub></b> = 3 by using 4 computers labeled by integers from 1 to 4. Let the correct password be 1, and wrong passwords be 2 and 3. Also since all computers are the same we may assume that Ciel will copy the piece and the program to the first computer and always choose the first several computers.<br />
Some of Ciel's choices are the following:
</p>
<p>
<b>1)</b> Ciel uses only 1 computer.<br />
In this case the time for connections is not needed.<br />
The running time is <b>T<sub>j</sub></b> nanoseconds if the computer checks 1 at first (probability 1/3).<br />
The running time is 2 * <b>T<sub>j</sub></b> nanoseconds if the computer checks passwords in order (2, 1) or (3, 1) (probability 1/3).<br />
The running time is 3 * <b>T<sub>j</sub></b> nanoseconds if the computer checks passwords in order (2, 3, 1) or (3, 2, 1) (probability 1/3).<br />
...
<p>
<b>2)</b> Ciel uses 2 computers. Then there is only one scenario of how the piece and the program will be distributed among the computers: computer 1 will send the program and the piece to the computer 2.<br />
...
<p>
<b>3)</b> Ciel uses 3 computers. In this case several preferences lists choices are available. For example, one of such choices can be represented as {(2, 3), (1, 3), (2, 1)}. Here (2, 3) is the preference list of computer 1, (1, 3) is the preference list of computer 2 and (2, 1) is the preference list of computer 3. For this scenario at first computer 1 will send the piece and the program to computer 2. And then both computers 1 and 2 will try to connect to computer 3.<br />
...
<h3>Input</h3>
<p>
The first line of the input contains a single integer <b>Q</b>, the number of test cases.<br />
...
- The next <b>C</b> lines describe the information about computer centers.<br />
...
<p>
<b>Case 1.</b> Here Ciel has no choice other than she goes to the first computer center and cracks the password for the only piece by using 1 computer, then Ciel back to her restaurant.<br />
The answer is 1 (going to the computer center) + 50.5 (cracking) + 1 (back to her restaurant) = 52.5.<br />
In the cracking phase since Ciel uses only one computer the time for connection is not needed.<br />
The program will check passwords one by one and 1 nanosecond is needed for checking one password.<br />
So the running time will be <b>k</b> nanoseconds with probability 1% for 1 ≤ <b>k</b> ≤ 100.<br />
...
Therefore the minimum expected time is 130.<br />
Here the expected time for cracking phase in the last choice is calculated as follows:<br />
At first, the program and piece are sent by computer 1 to computer 2, and the needed average time is 1 nanoseconds.<br />
Then 2 computers run the brute-force program.<br />
Let the correct password be 1, and the wrong one be 2.<br />
