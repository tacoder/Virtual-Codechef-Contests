<?php require("../../includes/header.php"); ?><h1>Three-Degree-Bounded Maximum Cost Subtree</h1><div class="content">
<h3> Read problems statements in Mandarin Chinese <a target="_blank" href="http://www.codechef.com/download/translated/OCT13/mandarin/DEG3MAXT.pdf">here</a></h3>
...
<h3>Explanation</h3>
</p><p><b>Example case 1.</b> The maximum cost of a part P which satisfies the restrictions is 11. There are two such maximum cost parts, both of them containing all the cities and the following roads:
<ul>
